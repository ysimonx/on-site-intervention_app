...
class widgetSchema extends StatefulWidget {
  ...
  @override
  State<widgetSchema> createState() => _widgetSchemaState();
}

class _widgetSchemaState extends State<widgetSchema> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      (svpP != null) ? svpP : Text(translateI18N("schema"))
    ]);
  }
}

/// This is a standard one line text entry  It's based on the [TextFormField] widget.
class CardSettingsSchema extends FormField<String>
      ...
      : assert(maxLength > 0),
        ...
        super(
          ...
          builder: (FormFieldState<String> field) =>
              (field as _CardSettingsSchemaState)._build(field.context),
        );
  ...
  @override
  _CardSettingsSchemaState createState() => _CardSettingsSchemaState();
}

class _CardSettingsSchemaState extends FormFieldState<String> {
  TextEditingController? _controller;

  @override
  CardSettingsSchema get widget => super.widget as CardSettingsSchema;
  ...
  @override
  void didUpdateWidget(CardSettingsSchema oldWidget) {
